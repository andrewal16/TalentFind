...
const Talent = () => {
  ...
  return (
    <div className="justify-content mx-auto my-5 flex flex-col w-[90%] md:p-11 p-4 rounded-lg md:gap-10 bg-white gap-4 h-full">
      <ComingSoonModal></ComingSoonModal>
      <div className="flex flex-col text-black gap-4 h-full text-center">
      ...
      <div className="flex flex-col p-10 gap-2 overflow-y-auto shadow-xl overflow-y-auto">
