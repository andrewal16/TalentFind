const Footer = () => {
  return (
    <footer class="bg-gradient-to-br from-blue-500 to-gray-300 rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
